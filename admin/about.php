...
<head>
    <title>Редактирование О нас</title>
    <meta charset="utf-8">
...
<body>
    ...
    <?php if (!empty($_SESSION['user'])): ?>
        <div style="text-align: center;">
            ...
            <br>
            <?php if (!empty($res)): ?>
                <form action="/admin/about.php" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" value="Сохранить" name="update_about">Сохранить</button>
                </form>
                <br>
